                  ...
                  fun syncFromNetwork(): Boolean {
                      ...
                      fun loadCachedEvents(): List<TideEvent> {
                          ...
                          fun isCacheStale(maxAgeHours: Long = 20): Boolean {
                              ...
                              /**
                                   * El servicio de MeteoGalicia envuelve siempre la respuesta en un objeto
                                        * con la clave "mareas", cuyo valor es un array de dias, cada uno con su
                                             * propia "listaMareas". Formato real observado:
                                                  * {"mareas":[{"data":"...","listaMareas":[...]}, ...]}
                                                       */
